var seckill = {
	...
	URL: {
		now: function() {
			return '/org.seckill/seckill/time/now';
		},
		exposer: function(seckillId) {
			return '/org.seckill/seckill/' + seckillId + '/exposer';
		},
		execution: function(seckillId, md5) {
			return '/org.seckill/seckill' + '/'+seckillId +'/'+ md5 +'/execution';
		}
	},
	// 详情页秒杀逻辑
